...
public class KursiStudioNerve extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buttonback.setBounds(50, 660, 90, 31);
        ...
        buttonreset.setBounds(150, 660, 90, 31);
        ...
        jPanel1.add(buttonbook);
        buttonbook.setBounds(910, 660, 90, 31);
    ...
    {   // mengambil data
        String namafilm = tf_hargapokok.getText();
        String hari = String.valueOf(tf_hari.getText());
        String jamtayang = tf_jam.getText();
        String nokursi = tf_nokursi.getText();
        String jumlahtiket = tf_jmltiket.getText();
